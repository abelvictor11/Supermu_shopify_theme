(function($){
    ...
    class CarouselCategories extends HTMLElement {
        constructor() {
            super();
        ...
        load() {
            ...
            function initialize() {
                var $prev = $carousel.find('[data-js-carousel-prev]'),
                    ...
                    infinite = $carousel.attr('data-infinite') === 'true',
                    arrows = $carousel.attr('data-arrows') === 'true',
                    bullets = $carousel.attr('data-bullets') === 'true';
                ...
                if (arrows) {
                    $(window).on('theme.resize.carousel-categories', arrowsPosition);
                }
        ...
        disconnectedCallback() {
            if(this.$slick) {
                ...
                $(window).unbind('theme.resize.carousel-categories');
            }
        }
    }

    theme.AssetsLoader.onPageLoaded(function() {
        customElements.define('carousel-categories', CarouselCategories);
    });
})(jQueryTheme);
