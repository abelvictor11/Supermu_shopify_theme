...
| Shop Pay/pagos acelerados | NOT_TESTED — Shopify Functions de validación soportan express checkout, incluido Shop Pay, pero falta confirmar que VOL instala/activa esa Function y observar los intentos reales. | NOT_TESTED — no se observó Shop Pay. La guía reserva la UI de checkout que “works with Shop Pay” para “Plus / Shopify Plus”; en Advanced esta limitación documentada bloquea/no prioriza Magical hasta que soporte e instalación aislada demuestren cobertura exacta. | [API Shopify de validación](https://shopify.dev/docs/api/functions/latest/cart-and-checkout-validation) (consultada 2026-09-08); [guía Magical, “Enable the Checkout UI Extension”](https://www.magicalapps.com/setup/how-to-setup-magical-fees) (consultada 2026-09-08). |
...
4. Magical no está seleccionada ni priorizada para prueba en Advanced: su documentación reserva la integración nativa de checkout/Shop Pay para Plus/Shopify Plus. Además, su guía para fees de método de pago indica que acelerados no aplican en no-Plus y exige ocultar botones dinámicos. Es una limitación documentada fuerte, no una prueba observada de incumplimiento; sólo soporte e instalación aislada podrían resolverla.
...
3. Sólo si la respuesta es afirmativa y la instalación aislada existe, ejecutar los casos de frontera, el descuento, cambios/eliminación de línea, `/checkout`, checkout normal, Shop Pay, pedido y reembolso. Si VOL falla cualquiera, no priorizar Magical como sustituta en Advanced sin una respuesta de soporte y prueba aislada que resuelvan explícitamente su limitación documentada de Shop Pay.
